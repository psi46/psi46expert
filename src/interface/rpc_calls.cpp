...
const unsigned int CTestboard::rpc_cmdListSize = 77;
...
const char *CTestboard::rpc_cmdName[] =
{
	...
	/*    66 */ "roc_SetDAC$vCC",
	/*    67 */ "roc_Pix$vCCC",
	/*    68 */ "roc_Pix_Trim$vCCC",
	/*    69 */ "roc_Pix_Mask$vCC",
	/*    70 */ "roc_Pix_Cal$vCCb",
	/*    71 */ "roc_Col_Enable$vCb",
	/*    72 */ "roc_Col_Mask$vC",
	/*    73 */ "roc_Chip_Mask$v",
	/*    74 */ "testColPixel$bCC2C",
	/*    75 */ "Ethernet_Send$v3c",
	/*    76 */ "Ethernet_RecvPackets$I"
};
