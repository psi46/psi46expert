...
#ifndef TBDIGITALINTERFACE
#define TBDIGITALINTERFACE

#include "BasePixel/TBInterface.h"
#include "BasePixel/ConfigParameters.h"
#include "BasePixel/pixel_dtb.h"

class TBDigitalInterface: public TBInterface
{
public:
    TBDigitalInterface(ConfigParameters * configParameters);
    virtual ~TBDigitalInterface();
