  ...
  if(!(strcmp(fpLM->getMTBConfigParameters()->GetMaskFileName(),"default")==0)){
	...
	uint32_t oldFilledMem = 0; // remember previous state of filledMem to recognize a blocked state
	  ...
	  if( (seconds-1)%20 == 0 ) {
		...
		std::cout
		  << "  _            __  __             _     _            _            _ _ " << endl
		  << " | |__  _   _ / _|/ _| ___ _ __  | |__ | | ___   ___| | _____  __| | |" << endl
		  << " | '_ \\| | | | |_| |_ / _ \\ '__| | '_ \\| |/ _ \\ / __| |/ / _ \\/ _` | |" << endl
		  << " | |_) | |_| |  _|  _|  __/ |    | |_) | | (_) | (__|   <  __/ (_| |_|" << endl
		  << " |_.__/ \\__,_|_| |_|  \\___|_|    |_.__/|_|\\___/ \\___|_|\\_\\___|\\__,_(_)" << endl << endl;
		//beep
		std::cout << '\a';
		// gui warning:
		fCanvas1->cd();
	  ...
	  if( filledSize == 0 && !bufferFullWarned ) {
	    ...
	    std::cout
	      ...
	      << "  _            __  __              __       _ _ " << endl
	      << " | |__  _   _ / _|/ _| ___   __   / _|    _| | |" << endl
	      << " | '_ | | | | | |_| |_ / _| | '__| |_  | | | | | |" << endl
	      << " | |_)   |_| |  _|  _|  __/ |    |  _| |_| | | |" << endl
	      << " |_.__/  |__,_|_| |_|  | __ |_|  | |   |_ __,_|_|_|" << endl<< endl;
