...
void ThresholdMap::SetParameters(const char * mapName, int mode)
{
    cals = false;
    xtalk = false;
    reverseMode = false;
...
TH2D * ThresholdMap::GetMap(const char * mapName, TestRoc * roc, TestRange * testRange, int nTrig, int mode)
{
